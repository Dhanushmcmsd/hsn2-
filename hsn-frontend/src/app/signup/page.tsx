    ...
    <div style={{
      ...
      <div style={{ width: "100%", maxWidth: 420 }}>
        ...
        <div style={{
          ...
          <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 1, background: "linear-gradient(90deg, transparent, rgba(1,128,235,0.6), transparent)" }} />
          ...
          <p style={{ marginTop: "1.5rem", textAlign: "center", fontSize: "0.8rem", color: "#CEDDFA55" }}>
            ...
            <Link href="/login" style={{ color: "#0180EB", textDecoration: "none", fontWeight: 500, textShadow: "0 0 8px rgba(1,128,235,0.4)" }}>
              Sign in
            </Link>
          </p>
        </div>
